...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add parallax effect to decorations on scroll
    let lastScroll = 0;
    ...
    const links = document.querySelectorAll('.social-link, .contact-link');
    links.forEach(link => {
    ...
    // Observe sections
    const sections = document.querySelectorAll('.video-section, .social-section, .contact-section');
